        ...
        <div className="our-apps-card">
          ...
          <div className="our-apps-content">
            ...
            <AppText className="our-apps-text">
              ...
              Imagine you are on a date with someone who seems absolutely perfect – attractive, charming and even makes you laugh.

              But then, suddenly something happens.

              It turns out that your date doesn’t believe in the moon landing.

              Is this a dealbreaker for you, or would you consider going on One More Date?
            ...
            <div className="our-apps-cards">
              ...
              <div className="omd-card">
                ...
                <span className="omd-card-intro">
                  How about…
                </span>

                <p>
                  Your date only brushes their teeth once a day
                </p>
              ...
              <div className="omd-card">
                ...
                <p>
                  Your date was born as a different gender than they are today
                </p>
            ...
            <AppText className="our-apps-text">
              ...
              One More Date promises plenty of laughs and, occasionally, a few heated discussions.

              It’s a perfect game for a girls night, an afterwork, or getting to know new people on a deeper level.
