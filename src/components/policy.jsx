...
const Policy = () => {
  return (
    <div className='outer-policy-cont'>
      ...
      <p>
       The information regarding in-app purchases is stored in the user's local storage solely for the purpose of restoring and managing the purchases within the app. 
